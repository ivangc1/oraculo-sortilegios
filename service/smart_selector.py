...
_YES_NO_VERBS = (
    ...
    "me engaña", "me engana", "me miente", "me piensa", "me olvida",
    ...
    "es una señal", "es una senal", "lo supero", "lo superaré", "lo superare",
    ...
    "merezco más", "merezco mas", "merezco mejor", "merezco esto",
    "es normal lo que siento", "es real lo que siento",
    "es una buena señal", "es una buena senal", "es mala señal", "es mala senal",
...
_TEMPORAL_KEYWORDS = {
    ...
    "próximo año", "proximo año", "proximo ano", "esta semana", "este mes",
    "este año", "este ano",
    ...
    "rumbo", "dirección de", "direccion de", "en breve", "avance",
    "periodo", "período",
...
_COMPLEX_KEYWORDS = {
    ...
    "con él", "con el", "con ella", "con ellos", "con mi pareja",
    ...
    "tóxico", "toxico", "relación tóxica", "relacion toxica",
    "persona tóxica", "persona toxica",
    ...
    "manipulación", "manipulacion", "sin control", "fuera de control",
    "bajo control", "perder el control", "dependencia",
    ...
    "celos", "envidia",
    "decepción", "decepcion", "desilusión", "desilusion",
    ...
    "sincronías", "sincronias", "ángel guardián", "angel guardian",
    ...
    "compañeros de trabajo", "companeros de trabajo",
    "grupo de amigos", "comunidad",
