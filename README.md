...
- **Spoiler en interpretaciones**: las lecturas se envian ocultas (`<tg-spoiler>`). El usuario pulsa para revelar. Texto intro visible: "Pulsa el texto oculto para revelar la lectura". Desactivable con `USE_SPOILER=false` en `.env`.
